      ...
      <section className={styles.heroSection}>
        ...
        <div className="container position-relative z-2 text-center">
          ...
          <h1 className={styles.heroTitle}>
            مهمتنا هي{" "}
            <span className={styles.gradientText}>الإعلام والإلهام</span>
          </h1>
              ...
              <div key={index} className="col-sm-6 col-lg-4">
                <div className={styles.teamCard}>
                  ...
                  <div className="d-flex justify-content-center gap-2 mt-3">
                    <a href="#" className={styles.socialBtnOrange}>
                      <i className="fa-brands fa-x-twitter"></i>
                    </a>
                    <a href="#" className={styles.socialBtnDark}>
                      <i className="fa-brands fa-linkedin-in"></i>
                    </a>
                    <a href="#" className={styles.socialBtnBlue}>
