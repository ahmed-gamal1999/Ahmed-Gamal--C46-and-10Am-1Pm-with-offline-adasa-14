      ...
      <div className="container position-relative">
        ...
        <div className="row gy-5">
          ...
          <div className="col-lg-2 col-md-6">
            ...
            <ul className={footerCss.linksList}>
              <li>
                <Link to="/home" className={footerCss.footerLink}>
                  الرئيسية
                </Link>
              </li>
              <li>
                <Link to="/blog" className={footerCss.footerLink}>
                  المدونة
                </Link>
              </li>
              <li>
                <Link to="/about" className={footerCss.footerLink}>
                  من نحن
                </Link>
              </li>
            </ul>
          ...
          <div className="col-lg-3 col-md-6">
            ...
            <form>
              ...
              />
              <button type="button" className={footerCss.subscribeBtn}>
                اشترك
              </button>
            </form>
          </div>
        ...
        <div className={`row ${footerCss.bottomBar} mt-4 pt-3`}>
          <div className="col-md-6 text-center text-md-end mb-3 mb-md-0">
            ...
            <span className={footerCss.heartIcon}>
          ...
          <div className="col-md-6 text-center text-md-start">
            <div className={footerCss.bottomLinks}>
              <Link to="/privacy" className={footerCss.footerLink}>
                سياسة الخصوصية
              </Link>
              <Link to="/terms" className={footerCss.footerLink}>
                شروط الخدمة
              </Link>
            </div>
          </div>
